# -*- coding: utf-8 -*-
"""
Created on Thu May 17 13:05:01 2018
...
vidcap = cv2.VideoCapture('video/bw_nature.mp4')
success,image = vidcap.read()
count = 0
success = True
while success:
  cv2.imwrite("video/frame%d.tiff" % count, image)     # save frame as TIFF file      
  success,image = vidcap.read()
...
def collect_natural_patches(num_patches = 100000, patch_width = 8):
  ...
  nat_img_cnt = 0  
  image = PIL.Image.open('natural_images/frame' + str(nat_img_cnt) + '.tiff')
